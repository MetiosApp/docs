...
|-----------|------|---------|-------------|
| `apiHost` | `string` | `'https://api.metios.app'` | API endpoint for fetching survey config |
| `environment` | `string` | Auto-detected | Force 'dev' or 'production' environment |
...
<script>
  Metios.init({
    surveyId: 'your-survey-uuid',
    apiHost: 'https://your-custom-api.com',
